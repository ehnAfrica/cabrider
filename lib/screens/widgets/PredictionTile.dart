              ...
              children: <Widget>[
                ...
                Expanded(
                  child: Column(
                    ...
                    children: <Widget>[
                      Text(prediction.mainText,maxLines: 1, style: TextStyle(fontSize: 16),),
                      SizedBox(height: 2,),
                      Text(prediction.secondaryText,maxLines: 1, style: TextStyle(fontSize: 12, color: BrandColors.colorDimText),),
                    ],
                  ),
                )
              ],
